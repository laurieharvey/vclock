...
{
    EXPECT_LE(vc::vclock("a",vc::sclock(0)), vc::vclock("a",vc::sclock(1)));
}

TEST(poset, antisymmetry)
{
    vc::vclock a("a",vc::sclock(0));
    vc::vclock b("b",vc::sclock(0));
...
{
    EXPECT_LT(vc::vclock("a",vc::sclock(0)), vc::vclock("a",vc::sclock(1)));
}

TEST(vclock, supersedes)
{
    EXPECT_GT(vc::vclock("a",vc::sclock(1)), vc::vclock("a",vc::sclock(0)));
}

TEST(vclock, equals)
{
    EXPECT_EQ(vc::vclock("a",vc::sclock(0)), vc::vclock("a",vc::sclock(0)));
}
